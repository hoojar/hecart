	...
	<div class="box">
		<div class="heading">
			...
			<div class="buttons" id="ctrl-div">
				...
				<a onclick="$('form').attr('action', '<?php echo $delete; ?>'); $('form').submit();" class="button btn-red"><?php echo $button_delete; ?></a>
				<?php } ?>
			</div>
		</div>
		<div class="content">
				...
				<table class="list">
					...
					<tbody>
						...
						<tr>
							...
							<td class="left"><select onchange="((this.value !== '') ? window.open('/sale/customer/login?customer_id=<?php echo $customer['customer_id']; ?>&store_id=' + this.value) : null); this.value = '';">
