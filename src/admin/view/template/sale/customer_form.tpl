		...
		<div class="content">
			...
			<div id="tab-general">
				<div id="vtabs" class="vtabs">
					...
					<a href="#tab-address-<?php echo $address_row; ?>" id="address-<?php echo $address_row; ?>"><?php echo $tab_address . ' ' . $address_row; ?>&nbsp;<img src="/view/image/delete.png" onclick="$('#vtabs a:first').trigger('click'); $('#address-<?php echo $address_row; ?>').remove(); $('#tab-address-<?php echo $address_row; ?>').remove(); return false;" /></a>
					<?php $address_row++; ?>
					<?php } ?>
					<span id="address-add"><?php echo $button_add_address; ?>&nbsp;<img src="/view/image/add.png" onclick="addAddress();" /></span>
				</div>
...
{
	loadCounty(element.value, zone_id, 'address[' + index + '][country_id]', 'address[' + index + '][zone_id]', 'address[' + index + '][city]', 'postcode-required' + index);
}
...
function addAddress()
{
	...
	html += '			<td id="address' + address_row + 'city" data=""><input type="text" name="address[' + address_row + '][city]" value="" /></td>';
	html += '		</tr>';
	html += '		<tr>';
	...
	$('#address-add').before('<a href="#tab-address-' + address_row + '" id="address-' + address_row + '"><?php echo $tab_address; ?> ' + address_row + '&nbsp;<img src="/view/image/delete.png" onclick="$(\'#vtabs a:first\').trigger(\'click\'); $(\'#address-' + address_row + '\').remove(); $(\'#tab-address-' + address_row + '\').remove(); return false;" /></a>');
	$('.vtabs a').easyTabs();
	$('#address-' + address_row).click();
	address_row++;
}
//--></script>
<script type="text/javascript"><!--
