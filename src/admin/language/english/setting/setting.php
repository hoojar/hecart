...
$_['entry_admin_limit']            = 'Default Items Per Page (Admin):<span class="help">Determines how many admin items are shown per page (orders, customers, etc)</span>';
$_['entry_product_count']          = 'Category Product Count:<span class="help">Show the number of products inside the subcategories in the storefront header category menu. Be warned, this will cause an extreme performance hit for stores with a lot of subcategories!</span>';
...
$_['entry_order_edit']             = 'Order Editing:<span class="help">Number of days allowed to edit an order. This is required because prices and discounts may change over time corrupting the order if it\'s edited.</span>';
$_['entry_invoice_prefix']         = 'Invoice Prefix:<span class="help">Set the invoice prefix (e.g. INV-2011-00). Invoice ID\'s will start at 1 for each unique prefix</span>';
...
$_['entry_return_status']          = 'Return Status:<span class="help">Set the default return status when an returns request is submitted.</span>';
$_['entry_logo']                   = 'Store Logo:';
$_['entry_icon']                   = 'Icon:<span class="help">The icon should be a PNG that is 16px x 16px.</span>';
$_['entry_image_maxsize']          = 'Upload Image Max Size:<span class="help">Upload the image of the biggest is more than a few, the unit of KB.</span>';
...
$_['entry_mail_parameter']         = 'Mail Parameters:<span class="help">When using \'Mail\', additional mail parameters can be added here (e.g. "<font color="red">-f </font>sender@hecart.com")';
...
$_['entry_alert_emails']           = 'Additional Alert emails:<span class="help">Any additional emails you want to receive the alert email, in addition to the main store email. (comma separated)</span>';
$_['entry_fraud_detection']        = 'Use MaxMind Fraud Detection System:<span class="help">MaxMind is a fraud detections service. If you don\'t have a license key you can <a onclick="window.open(\'http://www.maxmind.com/?rId=hecart\');"><u>sign up here</u></a>. Once you have obtained a key copy and paste it into the field below.</span>';
$_['entry_fraud_key']              = 'MaxMind License Key:</span>';
$_['entry_fraud_score']            = 'MaxMind Risk Score:<span class="help">The higher the score the more likly the order is fraudulent. Set a score between 0 - 100.</span>';
$_['entry_fraud_status']           = 'MaxMind Fraud Order Status:<span class="help">Orders over your set score will be assigned this order status and will not be allowed to reach the complete status automatically.</span>';
$_['entry_use_ssl']                = 'Use SSL:<span class="help">To use SSL check with your host if a SSL certificate is installed and added the SSL URL to the catalog and admin config files.</span>';
$_['entry_login_count_max']        = 'Max Login Amount：<span class="help">When a user login more than maximum logins, you will be prompted to lock the user does not make the connection.</span>';
$_['entry_login_locked_hours']     = 'Lock time login failure：<span class="help">When a user is locked, how many hours more than rear can log back in again.</span>';
