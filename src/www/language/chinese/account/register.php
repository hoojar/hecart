...
$_['text_agree']           = '我已经阅读并同意 <a class="tboxy" href="%s" alt="%s"><b>%s</b></a>条款';
...
// Error
$_['error_exists']     = '系统提示： 该邮箱地址已被注册、请另换一个电子邮箱！';
